...
int main(int argc, char** argv)
{
	...
	// Section3 准备纹理对象
	GLint textureId1 = TextureHelper::load2DTexture("butterfly.png");
	GLint textureId2 = TextureHelper::load2DTexture("zongzi.png");
	//这里加载shopping.png失败，经验证是不支持shopping图片（可能需要的颜色比较多），但支持zongzi.png文件
