...
int main(int argc, char** argv)
{
	...
	if (!ObjLoader::loadFromFile("cube.obj", vertData))
	{
	...
	GLint diffuseMap = TextureHelper::load2DTexture("cat_ghost.png");
	GLint specularMap = TextureHelper::load2DTexture("cat_ghost.png");
	shader.use();
