			...
			<div class="row">
				...
				<div class="col-xs-10 text-right menu-1">
					<ul>
						...
						<li class="active"><a href="l_class.jsp">分类</a></li>
						<li><a  href="l_create_entry.jsp">创建词条</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=艺术')" class="project-grid" style="background-image:url(images/class/art.jpg);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=科学')" class="project-grid" style="background-image:url(images/class/science.png);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=自然')" class="project-grid" style="background-image:url(images/class/nature.png);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=文化')" class="project-grid" style="background-image:url(images/class/culture.png);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=地理')" class="project-grid" style="background-image:url(images/class/geography.png);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=生活')" class="project-grid" style="background-image:url(images/class/life.jpg);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=社会')" class="project-grid" style="background-image:url(images/class/society.png);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=人物')" class="project-grid" style="background-image:url(images/class/personage.jpg);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=经济')" class="project-grid" style="background-image:url(images/class/economic.jpg);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=运动')" class="project-grid" style="background-image:url(images/class/sports.jpg);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=历史')" class="project-grid" style="background-image:url(images/class/history.jpg);">
						<div class="desc">
							<span>千寻百科</span>
				...
				<div class="col-md-4 animate-box">
					<div onclick="window.open('l_one_class.jsp?category=其他')" class="project-grid" style="background-image:url(images/class/others.jpg);">
						<div class="desc">
							<span>千寻百科</span>
