			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-9 col-md-offset-1 animate-box">
						<h3>基本信息：</h3>
						<form name="create_entry" method="post" ENCTYPE="multipart/form-data">
							<div class="row form-group">
								<div class="col-md-7">
									<!-- <label for="fname">First Name</label> -->
									词条标题：<input type="text" name="title" class="form-control" placeholder="你要创建的词条名">
								</div>
								<div class="col-md-5">
									词条类型：<select name="category" class="form-control">
										<option selected value="艺术">艺术</option>
							...
							<div class="row form-group">
								<div class="col-md-8">
									...
									词条义项名：<input type="text" name="brief" class="form-control" placeholder="如果该词条有多个意义，请您对您的词条做个说明。没有请跳过。">
								</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									词条概述：<textarea  name="article_0" cols="30" rows="5" class="form-control" placeholder="对这个词条做个大概的描述，让读者读过概述就能了解词条的基本内容。"></textarea>
								</div>
							</div>
							...
							<div class="row form-group" id="article">
								...
								<div class="col-md-7">
									<!-- <label for="fname">First Name</label> -->
									<input type="text" name="title_1"  class="form-control" placeholder="正文块标题">
								</div>
								<div class="col-md-12">
									<!-- <label for="message">Message</label> -->
									<textarea name="article_1" cols="30" rows="7" class="form-control" placeholder="正文内容"></textarea>
								</div>
							</div>
