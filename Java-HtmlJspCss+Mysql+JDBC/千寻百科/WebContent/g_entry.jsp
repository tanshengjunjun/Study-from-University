...
<title><%=entry.getTitle()%>_千寻百科</title>
	...
	<script>
		function pass() {
			...
			th.submit();
			if(confirm("确认审核通过？"))
			    th.action="<%=path%>/QXBK2/PassEntryAction";
			else
			    ;
        }
        ...
        function quit() {
			...
			th.submit();
			if(confirm("确定删除该词条？"))
				th.action="<%=path%>/QXBK2/DeleteEntryAction";
			else
			    ;
        }
	</script>
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li><a href="g_check_entry.jsp">审核词条</a></li>
	...
	<div id="fh5co-about">
		<div class="container">
			...
			<div class="row animate-box">
				...
				<a href="g_entry.jsp?entry_id=<%=e.getEntry_id()%>"><%=(entryList.indexOf(e)+1)+"."+e.getBrief()%></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<%}%>
			</div>
			<%}%>
			<div class="row animate-box">
				...
				<%if(entry.isPassed()){ %>
					<button class="btn btn-danger" onclick="quit()">&nbsp;&nbsp;&nbsp;删除&nbsp;&nbsp;&nbsp;</button>
				<%}else{ %>
					<button class="btn btn-success" onclick="pass()">&nbsp;&nbsp;&nbsp;通过&nbsp;&nbsp;&nbsp;</button>
					<button class="btn btn-danger" onclick="quit()">&nbsp;&nbsp;&nbsp;删除&nbsp;&nbsp;&nbsp;</button>
				<%} %>
				</div>
				</form>
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<span>创建于<%=entry.getCreate_date()%></span>
				</div>
			</div>
