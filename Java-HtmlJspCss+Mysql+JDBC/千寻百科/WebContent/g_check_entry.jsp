<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	ArrayList<Entry> entryList = manager.getAllNotPassed();
    %>
...
<title>审核词条</title>
	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container">
			<div class="row">
				<div class="col-xs-2">
					<div id="fh5co-logo"><a href="g_index.jsp">千寻百科</a></div>
				</div>
				<div class="col-xs-10 text-right menu-1">
					<ul>
						<li><a href="g_index.jsp">查找词条</a></li>
						<li class="active"><a href="g_check_entry.jsp">审核词条</a></li>
						<li><a href="#"><%=manager.getName()%>，欢迎您！</a></li>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(images/QYQX11.jpg);">
	...
	<div id="fh5co-services">
		<h2 class="col-md-offset-1">待审核的词条：</h2>
		<div class="container">
			<%for(Entry entry : entryList){%>
			<div class="col-md-6 col-sm-6 animate-box">
				<div class="feature-center" onclick="window.location.href='g_entry.jsp?entry_id=<%=entry.getEntry_id() %>'">
